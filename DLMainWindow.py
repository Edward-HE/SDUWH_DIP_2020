...
class Ui_DLMainWindow(object):
    def setupUi(self, DLMainWindow):
        ...
        self.label_4 = QtWidgets.QLabel(self.LabCtrlWidget)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1333, 29))
        ...
        self.action = QtWidgets.QAction(DLMainWindow)
        self.action.setObjectName("action")
        self.action_2 = QtWidgets.QAction(DLMainWindow)
        self.action_2.setObjectName("action_2")
        self.action_3 = QtWidgets.QAction(DLMainWindow)
        self.action_3.setObjectName("action_3")
        self.menu.addAction(self.action_O)
        self.menu.addAction(self.action_S)
        self.menu.addAction(self.action_E)
        self.menu_G.addAction(self.action)
        self.menu_G.addAction(self.action_2)
        self.menu_G.addAction(self.action_3)
    ...
    def retranslateUi(self, DLMainWindow):
        ...
        self.label_4.setText(_translate("DLMainWindow", "TextLabel"))
        ...
        self.action.setText(_translate("DLMainWindow", "缩放"))
        self.action_2.setText(_translate("DLMainWindow", "旋转"))
        self.action_3.setText(_translate("DLMainWindow", "镜像"))
