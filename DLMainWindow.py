...
class Ui_DLMainWindow(object):
    def setupUi(self, DLMainWindow):
        ...
        self.menu_edge_detect = QtWidgets.QMenu(self.menubar)
        self.menu_edge_detect.setObjectName("menu_edge_detect")
        self.menu_segment = QtWidgets.QMenu(self.menubar)
        self.menu_segment.setObjectName("menu_segment")
        ...
        self.action_robert = QtWidgets.QAction(DLMainWindow)
        self.action_robert.setObjectName("action_robert")
        self.action_sobel = QtWidgets.QAction(DLMainWindow)
        self.action_sobel.setObjectName("action_sobel")
        self.action_canny = QtWidgets.QAction(DLMainWindow)
        self.action_canny.setObjectName("action_canny")
        self.action_thresh_global = QtWidgets.QAction(DLMainWindow)
        self.action_thresh_global.setObjectName("action_thresh_global")
        self.action_thresh_adptive = QtWidgets.QAction(DLMainWindow)
        self.action_thresh_adptive.setObjectName("action_thresh_adptive")
        self.action_otsu_s = QtWidgets.QAction(DLMainWindow)
        self.action_otsu_s.setObjectName("action_otsu_s")
        ...
        self.menu_edge_detect.addAction(self.action_robert)
        self.menu_edge_detect.addAction(self.action_sobel)
        self.menu_edge_detect.addAction(self.action_canny)
        self.menu_segment.addAction(self.action_thresh_global)
        self.menu_segment.addAction(self.action_thresh_adptive)
        self.menu_segment.addAction(self.action_otsu_s)
        self.menubar.addAction(self.menu.menuAction())
        self.menubar.addAction(self.menu_G.menuAction())
        self.menubar.addAction(self.menu_H.menuAction())
        self.menubar.addAction(self.menu_N.menuAction())
        self.menubar.addAction(self.menu_edge_detect.menuAction())
        self.menubar.addAction(self.menu_segment.menuAction())
    ...
    def retranslateUi(self, DLMainWindow):
        ...
        self.menu_edge_detect.setTitle(_translate("DLMainWindow", "锐化与边缘检测(E)"))
        self.menu_segment.setTitle(_translate("DLMainWindow", "图像分割(S)"))
        ...
        self.action_robert.setText(_translate("DLMainWindow", "Robert算子"))
        self.action_sobel.setText(_translate("DLMainWindow", "Sobel算子"))
        self.action_canny.setText(_translate("DLMainWindow", "Canny算子"))
        self.action_thresh_global.setText(_translate("DLMainWindow", "全局阈值"))
        self.action_thresh_adptive.setText(_translate("DLMainWindow", "自适应阈值"))
        self.action_otsu_s.setText(_translate("DLMainWindow", "Otsu\'s 二值化"))
